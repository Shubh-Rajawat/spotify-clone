    ...
    return (
        <div className="song-actions mb-7">
            <div className="controls-right song-actions">
                <div className="">
                    <i
                        class="fa-solid fa-headphones mx-3 cursor-pointer text-neutral-600 hover:text-white"
                        title="Now playing"
                        onClick={ () => dispatch( nowPlayingActions.toggleNowPlaying() ) }
                    ></i>
                    <i
                        class="fa-solid fa-microphone mx-3 cursor-pointer text-neutral-600 hover:text-white"
                        title="Lyrics"
                    ></i>
                    <i
                        class="fa-solid fa-grip-lines mx-3 cursor-pointer text-neutral-600 hover:text-white"
                        title="Queue"
                    ></i>
                    <i
                        class="fa-solid fa-mobile mx-3 cursor-pointer text-neutral-600 hover:text-white"
                        title="Connect to a device"
                    ></i>
                    <i class="fa-solid fa-volume-off mx-3 cursor-pointer text-neutral-600 hover:text-white"></i>
